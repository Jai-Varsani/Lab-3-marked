...
const searchNumclientService = function(num_client, callback) {
    clientDAO.findByNumClientInClientTable(num_client, function(err, rows){
        if(err){
            throw err;
        } else{
            callback(false,rows);
...
const searchUsernameclientService = function(username, callback) {
    clientDAO.findByUsernameInClientTable(username, function(err, rows){
        if(err){
            throw err;
        } else{
            callback(false,rows);
